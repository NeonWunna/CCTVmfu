<script setup>
import { ref, computed, onMounted, onUnmounted, shallowRef, useTemplateRef, watch, createApp } from 'vue';
import { useRouter } from 'vue-router';
import logoUrl from '../assets/mfu-logo.png';
import Toast from '../components/ui/Toast.vue';
import ConfirmModal from '../components/ui/ConfirmModal.vue';
import CameraInfoCard from '../components/ui/CameraInfoCard.vue';
...
const addMarker = (cctv) => {
  ...
  marker.addListener("click", () => {
    ...
    // Create a Vue app instance with the CameraInfoCard component
    const app = createApp(CameraInfoCard, {
      camera: cctv,
    ...
    // Create new InfoWindow with the Vue component content
    if (!infoWindow.value) {
    ...
    infoWindow.value.setContent(containerDiv);
